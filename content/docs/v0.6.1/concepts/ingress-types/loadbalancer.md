...
- First, install Voyager operator in your cluster following the steps [here](/docs/v0.6.1/setup/install).

- Now, deploy test servers using [this script](/docs/v0.6.1/examples/ingress/types/loadbalancer/deploy-servers.sh) script.
