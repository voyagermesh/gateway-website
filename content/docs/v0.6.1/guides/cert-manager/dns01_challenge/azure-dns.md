...
![a-record](/docs/v0.6.1/images/cert-manager/azure/a-record.png)
...
![new-registration](/docs/v0.6.1/images/cert-manager/azure/new-registration.png)
![new-registration2](/docs/v0.6.1/images/cert-manager/azure/new-registration2.png)

You'll need the `Application (client) ID` and `Directory (tenant) ID` later for creating issuer.

![client-tenant](/docs/v0.6.1/images/cert-manager/azure/client-tenant.png)

Now, create a new client-secret.

![client-secret](/docs/v0.6.1/images/cert-manager/azure/client-secret.png)
...
![subscriptions](/docs/v0.6.1/images/cert-manager/azure/subscriptions.png)
...
![user-access](/docs/v0.6.1/images/cert-manager/azure/user-access.png)
...
![dns-zone-contributor](/docs/v0.6.1/images/cert-manager/azure/dns-zone-contributor.png)

Now create this issuer by applying [issuer.yaml](/docs/v0.6.1/examples/cert-manager/azure/issuer.yaml)
...
Now, Create [ingress.yaml](/docs/v0.6.1/examples/cert-manager/azure/ingress.yaml)
...
Then create this [certificate.yaml](/docs/v0.6.1/examples/cert-manager/azure/certificate.yaml)
