...
![svcac1](/docs/v0.6.1/images/cert-manager/google_dns/svcac1.png)
![svcac2](/docs/v0.6.1/images/cert-manager/google_dns/svcac2.png)
![svcac3](/docs/v0.6.1/images/cert-manager/google_dns/svcac3.png)
...
Now create this issuer by applying [issuer.yaml](/docs/v0.6.1/examples/cert-manager/google_cloud/issuer.yaml)
...
Now, Create [ingress.yaml](/docs/v0.6.1/examples/cert-manager/google_cloud/ingress.yaml)
...
Then create this [certificate.yaml](/docs/v0.6.1/examples/cert-manager/google_cloud/certificate.yaml)
