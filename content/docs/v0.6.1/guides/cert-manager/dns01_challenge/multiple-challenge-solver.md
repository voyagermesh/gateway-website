...
- [AzureDNS](/docs/v0.6.1/guides/cert-manager/dns01_challenge/azure-dns)
- [Cloudflare](https://docs.cert-manager.io/en/latest/tasks/issuers/setup-acme/dns01/cloudflare.html)
- [Google CloudDNS](/docs/v0.6.1/guides/cert-manager/dns01_challenge/google-cloud-dns)
- [Amazon Route53](/docs/v0.6.1/guides/cert-manager/dns01_challenge/aws-route53)
...
multiple dns providers, like [this](/docs/v0.6.1/examples/cert-manager/multiple.yaml):
