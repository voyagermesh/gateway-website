...
![iam](/docs/v0.6.1/images/cert-manager/route53/iam.png)

![add-user](/docs/v0.6.1/images/cert-manager/route53/add-user.png)

![access-type](/docs/v0.6.1/images/cert-manager/route53/access-type.png)

Click on next and select `Attach existing policies directly` and click on `Create Policy`. This will take you to a new page.

![create-policy](/docs/v0.6.1/images/cert-manager/route53/create-policy.png)
...
![review-policy](/docs/v0.6.1/images/cert-manager/route53/review-policy.png)

Now go back to previous add user page, hit the refresh button and attach this policy to this user:

![attach-policy](/docs/v0.6.1/images/cert-manager/route53/attach-policy.png)

Click on next (tags are optional - you can ignore this) and finish the process. Download the `.csv` file.

![success-user](/docs/v0.6.1/images/cert-manager/route53/success-user.png)
...
![hosted-zone-id](/docs/v0.6.1/images/cert-manager/route53/hosted-zone-id.png)

And put them in [issuer.yaml](/docs/v0.6.1/examples/cert-manager/route53/issuer.yaml)
...
Now create [ingress.yaml](/docs/v0.6.1/examples/cert-manager/route53/ingress.yaml):
...
![a-record](/docs/v0.6.1/images/cert-manager/route53/a-record.png)

## 3. Create Certificate

Then create this [certificate.yaml](/docs/v0.6.1/examples/cert-manager/route53/certificate.yaml)
