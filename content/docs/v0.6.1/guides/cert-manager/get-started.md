...
Like this [issuer.yaml](/docs/v0.6.1/examples/cert-manager/issuer.yaml)
...
You can change that value using `duration` and `renewBefore` field in [certificate.yaml](/docs/v0.6.1/examples/cert-manager/certificate.yaml),
