...
- `ca-file <file-path>`: Specify a CA file to verify the backend server. See [here](/docs/v0.6.1/guides/ingress/configuration/config-volumes) for complete example.
