...
Now, install Voyager operator in your `minikube` cluster following the steps [here](/docs/v0.6.1/setup/install).
...
- [Using HTTP-01 challenge](/docs/v0.6.1/guides/certificate/http/overview)
- [Using DNS-01 challenge](/docs/v0.6.1/guides/certificate/dns/providers)
