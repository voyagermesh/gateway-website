...
Now, deploy Voyager operator following instructions [here](/docs/v0.6.1/setup/install).

Note that the yaml files that are used in this tutorial, stored in [docs/examples](https://github.com/voyagermesh/gateway-docs/tree/master/docs/examples/monitoring) folder in GitHub repository [voyagermesh/voyager](https://github.com/voyagermesh/gateway-docs).
...
![stats-page](/docs/v0.6.1/images/monitoring/stats-view.png)
...
- To monitor your HAProxy pods using builtin [Prometheus](https://prometheus.io/) scraper, visit [here](/docs/v0.6.1/guides/ingress/monitoring/using-builtin-prometheus).
- To monitor your HAProxy pods using [CoreOS Prometheus Operator](/docs/v0.6.1/guides/ingress/monitoring/using-coreos-prometheus-operator), visit [here](/docs/v0.6.1/guides/ingress/monitoring/using-coreos-prometheus-operator).
- To monitor Voyager operator using Prometheus, visit [here](/docs/v0.6.1/guides/ingress/monitoring/operator-stats).
